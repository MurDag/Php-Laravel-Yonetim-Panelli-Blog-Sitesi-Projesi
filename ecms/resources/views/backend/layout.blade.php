...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{route('nedmin.index')}}"><i class="fa fa-link"></i> <span>Dashbord</span></a>
                </li>
                <li><a href="{{route('blog.index')}}"><i class="fa fa-address-book"></i> <span>Blog</span></a></li>
                <li><a href="{{route('page.index')}}"><i class="fa fa-address-book"></i> <span>Page</span></a></li>
                <li><a href="{{route('slider.index')}}"><i class="fa fa-address-book"></i> <span>Slider</span></a></li>
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{route('settings.index')}}"><i class="fa fa-link"></i> <span>Ayarlar</span></a>
                        </li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">Blog Yönetim Paneli</a>.</strong> All rights reserved.
    </footer>
